...
//-->RAMESH KUMAR
// console.log(eval("2+3") ,typeof eval("2+3"));
// ->> 5, number
//  eval treats content inside the string as JS source code

let newString = new String("hello");
// console.log(typeof newString, typeof newString.valueOf());
//  object string

let concatedString = str1.concat(" >>> ", newString);
// console.log(typeof concatedString,concatedString); 
// string Rahul Kumar >>> hello

// console.log(typeof str1.replace("Kumar", "Singh"),str1.replace("Kumar", "Singh"));
//  ->> Not inplace editing Rahul Singh : string Rahul Singh
// console.log(str1); 
// ->> Rahul 
...
// ->> starts from 3rd index and go 6 characters ahead
//  ->> starts from 3rd index and goes to 5th index
...
//   [num1.toLocaleString('en-IN')], // '1,00,000.121'
//   [num1], 100.121
...
const Obj1 = {
  ...
  info: function () {
    console.log(
      `Hello Everyone My Name is ${Obj1.username} and my salary is $${Obj1.salary} per month as a Software Developer in Meta since  May 2012`
    );
  },
};
// Obj1.info();
...
// };
// const { Degree: anyName } = education; De-Structing Object
// console.log(anyName); >>> B.Tech(Mechanical Engineering)
...
// user.info();
// { username: 'hitesh choudhary', price: 399, 
// info: [Function: info] }
...
// (function fun(){
  ...
  // }
  // )();
  // semicolon is to end the function context.
...
const filteredArr = newArr.filter((name) => (name.length > 4));
// returns modified array
// donot modify implicitly
// console.log(filteredArr, newArr);

// map return the updated value from current array 
// don not modify the current arr..
const updatedMap = newArr.map((item) => item + 10);
// console.log(updatedMap); 

// let valArr = [1, 2, 3, 4, 5];
// let reduceArr = valArr.reduce((acc, curr) => (acc + curr), 0);
